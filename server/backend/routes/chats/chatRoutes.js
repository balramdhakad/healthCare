...
import { getChat, getChatUsers, getUserInfo, sendMessage } from  "../../controllers/chats/chatControllers.js"
import upload from "../../config/multer.js"
const router = express.Router()


router.get("/users",auth("doctor","patient","admin"),getChatUsers)
router.get("/user/:userId",auth("doctor","patient","admin"),getUserInfo)
