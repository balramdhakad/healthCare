            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 px-4 bg-gray-50 rounded-md">
                  ...
                  <a href="mailto:sales@healthconnect.com" className="text-blue-600 hover:underline">sales@healthconnect.com</a>
                </div>
                <div className="flex justify-between items-center py-2 px-4 bg-gray-50 rounded-md">
                  <span className="text-gray-600 font-medium">General</span>
                  <a href="mailto:info@healthconnect.com" className="text-blue-600 hover:underline">info@healthconnect.com</a>
                </div>
                <div className="flex justify-between items-center py-2 px-4 bg-gray-50 rounded-md">
                  <span className="text-gray-600 font-medium">Phone</span>
                  <a href="tel:+18005550199" className="text-blue-600 hover:underline">+1-800-555-0199</a>
                </div>
              </div>
            </div>
