...
const PatientCard = ({ patient }) => {
  return (
    <div className="bg-blue-50 p-5 rounded-xl border border-blue-200 shadow-md text-center">
      ...
      <p className="text-sm text-blue-600 mb-2">View Patient Medical History</p>
      <Link
      ...
      <div className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-semibold text-white bg-green-600 mt-2 rounded-lg hover:bg-blue-700">
        <ChatButton id={patient?._id}/> {"  "} Chat with Patient
      </div>
    </div>
  );
};
