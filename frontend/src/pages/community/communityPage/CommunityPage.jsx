...
//         <Link to={`/community/createcommunity`} className="fixed bottom-6 right-6 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors">
//           <FaPlus />
//         </Link>
//       </main>
//     </div>
