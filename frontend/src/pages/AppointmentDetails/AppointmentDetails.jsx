...
const AppointmentDetails = () => {
  ...
  const { doctorId, status, date, time, reasonForVisit, notes, rating, tokenNo, isApproved } =
    appointment;
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-8">
        <div className="mb-8 border-b pb-4 flex justify-between items-center">
          <Link to="/appointments" className="text-blue-600 hover:text-blue-800 flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-700 mb-2">Appointment Status</h2>
              <AppointmentStatusBadge status={status} isApproved={isApproved} />
            </div>

            <AppointmentSchedule date={date} time={time} tokenNo={tokenNo} />
            <ConsultationDetails reasonForVisit={reasonForVisit} notes={notes} isCompleted={isCompleted} />
